        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <a href="{{ route('CRUDJobByEmployer.index') }}"><button class="btn btn-primary" style="float: right;">List
                            Post</button></a>
                    <br>
                    <br>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control"
                                        placeholder="Nhập tiêu đề cần sửa" value="{{ $show->title }}">
                                    @if ($errors->has('title'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="experience" class="form-control"
                                        placeholder="Nhập số năm kinh nghiệm" value="{{ $show->experience }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="type" class="form-control"
                                        placeholder="Nhập thời gian làm việc" value="{{ $show->type }}">
                                    @if ($errors->has('type'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="skill" class="form-control"
                                        placeholder="Nhập kỹ năng yêu cầu" value="{{ $show->skill }}">
                                    @if ($errors->has('skill'))
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="required" id="" cols="140" rows="3">{{ $show->required }}</textarea>
