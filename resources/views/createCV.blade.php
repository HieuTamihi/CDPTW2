@extends('header')
@section('footer')
    <<<<<<< HEAD:resources/views/createCV.blade.php <div class="form__createcv">
        <div class="container">
            ...
            <form action="{{ route('cv.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="resume_form">
                    <div class="input__field">
                        <input class="input__input" name="namecv" type="text" placeholder="Vui lòng nhập tên CV"
                            required style="width: 100%;">
                        =======
                        <div class="form__createcv">
                            <div class="container">
                                <p class="attention">Hướng dẫn <br>
                                    - Các trường thông tin có dấu (*) là trường thông tin quan trọng bắt buộc, giúp Nhà
                                    tuyển dụng đánh giá ứng
                                    viên. <br>
                                ...
                                <form action="">
                                    ...
                                    <div class="resume_form">
                                        ...
                                        <div class="input__field"> <label for="">Tên trường theo học (*)</label>
                                            <input class="input__input" type="text"
                                                placeholder="Vui lòng chọn trường theo học">
                                        </div>
                            ...
                            <div class="resume_form">
                                ...
                                <div class="input__field">
                                    <label for="">Họ và tên (*)</label>
                                    <input class="input__input" name="fullname" type="text"
                                        placeholder="Vui lòng nhập họ và tên" required>
                                </div>
                                <div class="input__field"> <label for="">Vị trí ứng tuyển (*)</label>
                                    <input class="input__input" name="apply_position" type="text"
                                        placeholder="Vui lòng chọn vị trí ứng tuyển" required>
                                </div>
                                <div class="input__field"> <label for="">Email (*)</label>
                                    <input class="input__input" name="email" type="email"
                                        placeholder="Vui lòng nhập email" required>
                                </div>
                                <div class="input__field"> <label for="">Số điện thoại (*)</label>
                                    <input class="input__input" name="phone_number" type="tel"
                                ...
                                <p class="title">Học vấn</p>
                                <div class="input__field"> <label for="">Tên trường theo học (*)</label>
                                    <input class="input__input" type="text" name="school_name"
                                        placeholder="Vui lòng chọn trường theo học" required>
                                </div>
                                <div class="input__field"> <label for="">Thời gian học tập (*)</label>
                                    <input class="input__input" name="learn_time" type="text" required>
                                </div>
                                <div class="input__field"> <label for="">Ngành học (*)</label>
                                    <input class="input__input" name="majors" type="text"
                                        placeholder="Vui lòng chọn ngành học" required>
                                </div>
                                <div class="input__field">
                                    <label for="">Thông tin khác</label>
