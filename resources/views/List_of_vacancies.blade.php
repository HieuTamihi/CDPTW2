        ...
        <div class="slidebar__menu">
            <ul>
                ...
                <form method="POST" name="logout" action="{{ route('logout') }}">
                    @csrf
                    <li> <a href="javascript:document.logout.submit()"><i
        ...
        <div class="body">
            <div class="manager__user">
                ...
                <div class="body__top">
                    ...
                    <a href="Add_vacancies">Add Vacancies</a>
                </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 10%;">
                                <div class="img">
                                    <img style="width: 100%;"
                                        src="{{asset('img/7165526-thiet-ke-logo-cong-ty-xay-dung-long-tien-hung.png')}}"
                                        alt="">
                                </div>
                            </td>
                            <td>Long Tiến Hưng</td>
                            <td>Hồ Chí Minh</td>
                            <td>Tốt Nghiệp ĐH, CĐ</td>
                            <td>Đang Sử Lý</td>
                            <td>29/10/2022</td>
                            <td>
