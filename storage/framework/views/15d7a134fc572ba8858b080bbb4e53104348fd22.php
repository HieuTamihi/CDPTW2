                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9">
                        <div class="noibat">
                            ...
                            <div class="content-nb">
                                <a href="#"><img src="<?php echo e(asset('img/blogit/' . $featuredPosts->image)); ?>"
                                        alt="Bai viet noi bat"></a>
                                <h4><a href="#"><?php echo e($featuredPosts->title); ?></a></h4>
                                <div class="meta">
                                    <span>Ngày đăng: <?php echo e($featuredPosts->created_at); ?></span>
                        ...
                        <div class="post-news">
                            ...
                            <div class="paginator">
                                ...
                                <?php echo e($newPost->appends(request()->all())->links()); ?>
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dthan\OneDrive\Documents\CD2\resources\views/blogit.blade.php ENDPATH**/ ?>