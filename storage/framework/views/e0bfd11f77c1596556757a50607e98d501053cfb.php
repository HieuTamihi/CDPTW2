<?php $__env->startSection('footer'); ?>
    ...
    <?php if(count($blogSearch) == '0'): ?>
        <div style="font-size: 20px; text-align:center">
            <span>OOPS! Hiện tại chúng tôi không thể tìm thấy <strong><?php echo e($request->keyword); ?></strong> mà bạn đang yêu cầu.
            </span>
            <ul>
        ...
        <div class="content-news" style="padding: 50px 300px">
            <?php $__currentLoopData = $blogSearch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="news-detail">
                    <a href="<?php echo e(route('blogDetail', $row->id)); ?>"><img src="<?php echo e(asset('img/blogit/' . $row->image)); ?>"
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\Documents\CD2\resources\views/blogit/blogit_search.blade.php ENDPATH**/ ?>