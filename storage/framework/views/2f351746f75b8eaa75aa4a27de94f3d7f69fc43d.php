...
<head>
    ...
    <script defer src="<?php echo e(asset('bootstrap.js')); ?>"></script>
    ...
    <section class="slidebar">
        ...
        <div class="slidebar__menu">
            <ul>
                ...
                <?php else: ?>
                <li> <a href="<?php echo e(route('login')); ?>"><i class="fa-solid fa-right-from-bracket"></i>Login</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </section>
...
</html><?php /**PATH C:\Users\dthan\OneDrive\Documents\CD2\resources\views/admin_homePage.blade.php ENDPATH**/ ?>